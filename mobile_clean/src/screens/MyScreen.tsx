                    ...
                    <View className="p-4 border-b border-gray-100">
                        ...
                        <View className="flex-row space-x-2">
                            ...
                            <TouchableOpacity
                                ...
                                className={`flex-1 py-2 rounded-lg items-center border ${i18n.language === 'zh' ? 'bg-laos-green border-laos-green' : 'bg-white border-gray-200'}`}
                            >
                                <Text className={`font-bold ${i18n.language === 'zh' ? 'text-white' : 'text-gray-600'}`}>中文</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
